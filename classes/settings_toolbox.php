 ...
 * Settings toolbox.
 */
class settings_toolbox {
    /**
     * Border styles.
     *
     * @return array border style strings.
     */
     ...
     * Font list.
     *
     * @return array font name strings.
     */
     ...
     * Font sizes.
     *
     * @return array font size strings.
     */
     ...
     * Numbers.
     *
     * @param int $start Starting number >= 0.
     * @param int $end Ending number >= Starting number.
     *
     * @return array number strings.
     */
     ...
     * Percents.
     *
     * @param float $start Starting number >= 0.
     * @param float $end Ending number >= Starting number.
     * @param float $increment Increment.
     *
     * @return array percentage strings.
     */
    public static function percentages($start, $end, $increment = 1.0) {
        return self::units($start, $end, $increment, '%');
    }

    /**
     * Pixels.
     *
     * @param int $start Starting number >= 1.
     * @param int $end Ending number >= Starting number.
     * @param bool $zero Have starting zero entry.
     *
     * @return array xpx strings.
     */
    public static function pixels($start, $end, $zero = true) {
        $pixels = [];
     ...
     * Row layouts.
     *
     * @return array row layout strings.
     */
    public static function rowlayouts() {
        return [
    ...
    public static function screensize($displaytype) {
        return [
            'd-' . $displaytype => new lang_string('bs4all', 'theme_adaptable'),
            'd-none d-sm-' . $displaytype => new lang_string('bs4small', 'theme_adaptable'),
            'd-none d-md-' . $displaytype => new lang_string('bs4medium', 'theme_adaptable'),
            'd-none d-lg-' . $displaytype => new lang_string('bs4large', 'theme_adaptable'),
            'd-none d-xl-' . $displaytype => new lang_string('bs4extralarge', 'theme_adaptable'),
            'd-none' => new lang_string('bs4none', 'theme_adaptable'),
        ];
    }
     ...
     * @param float $increment Increment.
     *
     * @return array second strings.
     */
    public static function seconds($start, $end, $increment = 1.0) {
        return self::units($start, $end, $increment, 's');
    }
