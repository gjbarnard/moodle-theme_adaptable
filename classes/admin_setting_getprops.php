        ...
        if ($saveprops) {
            ...
            $return .= html_writer::start_tag(
                ...
                [
                    ...
                    'data-title' => get_string('propertiesexportjsonstring', $this->pluginfrankenstyle),
                    'data-toggle' => 'tooltip',
                    'tabindex' => '0',
                ]
            );
            ...
            $propertiestableshowhidebutton .= html_writer::start_tag(
                ...
                [
                    ...
                    'data-title' => get_string('propertiestablecollapsehelp', $this->pluginfrankenstyle),
                    'data-toggle' => 'tooltip',
                    'tabindex' => '0',
                ]
            );
            $propertiestableshowhidebutton .= html_writer::tag(
                ...
                [
                    ...
                    'data-target' => '#adminprops_getprops_table',
            ...
            $propertiestablehidebutton .= html_writer::start_tag(
                ...
                [
                    'class' => 'd-inline-block',
                    'data-title' => get_string('propertiestablecollapsehidehelp', $this->pluginfrankenstyle),
                    'data-toggle' => 'tooltip',
                    'tabindex' => '0',
                ]
            );
