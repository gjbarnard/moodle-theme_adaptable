Change log in version 500.2.9 (2025040815)
==========================================
...
Change log in version 500.2.8 (2025040814)
==========================================
...
3. Refactor deprecated CSS classes ml, mr, form-group and btn-block.
4. Remove redundant CSS class 'coursesearchnavbar'.

Change log in version 500.2.7 (2025040812)
==========================================
1. Fix 'Hangs on upgradesettings-Page' #50.

Change log in version 500.2.6 (2025040811)
==========================================
1. 'shortcut' isn't used anymore for favicon.

Change log in version 500.2.5 (2025040810)
==========================================
...
I have done a lot of tiding of the styles, removing what I understand to be redundant in the process.  If I have removed a style that was there but now is not and you use it, then please raise and issue with a full description and screen shot(s) and I'll consider putting it back.
...
44. Validate value of 'coursetitlemaxwidth' when set externally to the UI.
...
Note: There is no thirteenth change.
